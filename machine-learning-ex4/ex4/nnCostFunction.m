...
% Define the size of theta matrix, this is to help the code will work on
% different size of data and number of layer.
...
%         computed in ex4.m
%
% Compute the parameters for the 2nd layer
a1= [ones(m,1) X];
z2=a1*Theta1';
a2=sigmoid(z2);

% Compute the parameters for the 3th layer
a2= [ones(m,1) a2];
z3=a2*Theta2';
a3=sigmoid(z3); % a3 is the predicted output by the model

% We calculate the cost of the model by using the same function as the
% exercise 3
% Compute cost
